<?php
    ...
    if($_POST)
    {
        ...
        $getInvoiceQuery=$conn->query("SELECT * FROM invoice_details invd INNER JOIN resturent_table rest ON invd.resturent_table_id=rest.resturent_table_id WHERE invd.invoice_details_id='$invoice_id'");
        ...
        $ProductQuantityPlusSql = "UPDATE invoice_details SET payment_status='1' WHERE invoice_details_id='$invoice_id' ";
        ...
        if ($conn->query($ProductQuantityPlusSql) === TRUE) 
        {
            ...
            while ($GIrs=$getInvoiceQuery->fetch_array()) {
                ...
                $conn->query("INSERT INTO invoice_save VALUES(null, '$invoice_id','$InvoiceWaiterId','$SubTotal','$TotalServiceCharge','$TotalDiscount','$FullTotal','$currentDate')");
                //Invoice Save Details
