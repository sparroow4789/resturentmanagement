                                                    ...
                                                    <div class="col-md-6">
                                                        <form class="row g-3" id="Add-Product">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="product_name" class="form-control" placeholder="Coke" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label">Product Code</label>
                                                                <input type="text" name="product_code" class="form-control" placeholder="XQ86S">
                                                            </div>
                                                            <div class="col-12">
                                                                <label class="form-label">Product Details *</label>
                                                                <textarea name="product_details" class="form-control" placeholder="Product Details" required></textarea>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label">Preparation Time *</label>
                                                                <input type="text" name="prep_time" class="form-control" placeholder="10 Min" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label">Calories *</label>
                                                                <input type="text" name="calories" class="form-control" placeholder="12kCal" required>
                                                            </div>
                                                            <div class="col-md-12">
