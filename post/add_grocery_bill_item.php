<?php
    ...
    if($_POST)
    {
        ...
        $ProductQuantitysql = "UPDATE grocery_item SET quantity=quantity+'$stock' WHERE grocery_item_id='$grocery_item_id' ";

        if ($conn->query($ProductQuantitysql) === TRUE) {
        //   echo "Record updated successfully";

            $DataADDGroceryBillItem = "INSERT INTO `grocery_bill_item`(`grocery_bill_item_id`, `grocery_bill_id`, `grocery_item_id`, `stock`, `cost`)
            VALUES (null, '$grocery_bill_id', '$grocery_item_id', '$stock', '$cost')";

            if ($conn->query($DataADDGroceryBillItem) === TRUE) {
