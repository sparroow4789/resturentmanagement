                                        ...
                                        <table id="datatable1" class="display" style="width:100%;">
                                            <thead>
                                                <tr>   
                                                    ...
                                                    <th><font style="float: right;">Service Charge (Rs.)</font></th>
                                            ...
                                            <tbody id="grocery-area">
                                                <?php
                                                    $sql = "SELECT * FROM invoice_save ins INNER JOIN invoice_details ind ON ins.invoice_id=ind.invoice_details_id INNER JOIN users_login ul ON ins.invoice_waiter_id=ul.user_id WHERE ind.invoice_type='1' ORDER BY ins.invoice_save_id DESC";
                                                    $rs=$conn->query($sql);
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="float: right;"><?php echo number_format($ServiceCharge,2); ?></font></td>
                                                    ...
                                                    <td>
                                                        <a href="table_invoice_view?i=<?php echo base64_encode($InvoiceId); ?>" class="btn btn-primary btn-sm">View</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
