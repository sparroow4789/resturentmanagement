                ...
                <div class="content-wrapper">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <h1><?php echo $RestaurantName; ?> Restaurant <font style="font-size: 20px;">(<?php echo $RestaurantPlace; ?>)</font></h1><br>
                            </div>
                                        ...
                                        <?php if ($ResturentTableAvailabilityStatus=='1') { ?>
                                            ...
                                            <div class="widget-stats-container d-flex">
                                                ...
                                                <div class="widget-stats-content flex-fill">
                                                    <span class="widget-stats-title notranslate">Current Cost</span>
