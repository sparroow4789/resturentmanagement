...
?>
<?php
    $getInvoiceQuery=$conn->query("SELECT * FROM invoice_save ins INNER JOIN invoice_details ind ON ins.invoice_id=ind.invoice_details_id WHERE ins.invoice_id='$InvoiceDetailsId'");
            ...
            display: none;
                                        ...
                                        <div class="row" id="print-preview">
                                            ...
                                            <div style="text-align: center;">
                                                <!--<img src="https://logodownload.org/wp-content/uploads/2015/02/burger-king-logo-1-1.png" style="width: 50%;">-->
                                            ...
                                            <tbody id="product-area">
                                                ...
                                                <?php
                                                    ...
                                                    while ($GIrs=$getInvoiceQuery->fetch_array()) {
                                                        ...
                                                        $ProductCountNew = $ProductDetailsExplode[0];
                                        ...
                                        <table>
                                            ...
                                            <tfoot>
                                                ...
                                                <th style="text-align: right; font-size: 18px; color: #000;" id="full-total"><?php echo number_format($FullTotal,2) ?></th>
                                            </tfoot>
                                            ...
                                            <tfoot>
                                                <th style="text-align: left; font-size: 18px; color: #000;">Service Charage (<?php echo $ServiceCharge; ?>%)</th>
                        ...
                        <div class="row" id="table-details">
                            <div class="page-description d-flex align-items-center">
                                <div class="page-description-content flex-grow-1 notranslate">
                                    <h1>Orders <font style="font-size: 15px;">Takeaway Invoice</font></h1>
                                </div>
                                    ...
                                    <div class="card widget widget-stats">
                                        <div class="card-body">
                                            ...
                                            <tfoot>
                                                ...
                                                <th style="border-style: hidden !important;"></th>
                                                <th style="border-style: hidden !important;"></th>
                                                <th style="text-align: right; font-size: 20px; color: #000; font-weight: 700;">Service Charage (<?php echo $ServiceCharge; ?>%)</th>
