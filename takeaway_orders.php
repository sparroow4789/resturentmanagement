<?php
    ...
    $InvoiceDetailsId= base64_decode($_GET['p']);
    $ProductCount=0;
    $SubTotal=0;
    $ServiceCharge=0;
...
?>
<?php
    $getInvoiceQuery=$conn->query("SELECT * FROM invoice_details WHERE invoice_details_id='$InvoiceDetailsId'");
        ...
        #print-preview{
            display: none;
                                        ...
                                        <div class="row" id="print-preview">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="notranslate" style="color: #000;">Item</th>
                                                    <th class="notranslate" style="text-align: right; color: #000;">Unit Cost</th>
                                                    <th class="notranslate" style="text-align: center; color: #000;">Qty</th>
                                                    <th class="notranslate" style="text-align: right; color: #000;">Total</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <!--------------------------------Start Products--------------------------------------->
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="margin-right: 8px; margin-left: 8px; color: #000;"><?php echo $InvoiceQty; ?></font></td>
                                            ...
                                            <tfoot>
                                                <th style="text-align: left; font-size: 18px; color: #000; font-weight: 700;">Total</th>
                                                <th style="text-align: right; font-size: 18px; color: #000; font-weight: 700;"><?php echo number_format($FullTotal,2) ?></th>
                                            </tfoot>
                                            
                                            <tfoot>
                                                <th style="text-align: left; font-size: 18px; color: #000; font-weight: 700;">Sub Total</th>
                                                <th style="text-align: right; font-size: 18px; color: #000; font-weight: 700;"><?php echo number_format($SubTotal,2); ?></th>
                                            </tfoot>

                                            <?php if ($ServiceCharge>0) { ?>
                                            <tfoot>
                                                <th style="text-align: left; font-size: 18px; color: #000; font-weight: 700;">Service Charge (<?php echo $ServiceCharge; ?>%)</th>
                                                <th style="text-align: right; font-size: 18px; color: #000; font-weight: 700;"><?php echo number_format($TotalServiceCharge,2); ?></th>
                                            </tfoot>
                                            <?php }else{} ?>
                                            <?php if ($InvoiceDiscount>0) { ?>
                                            <tfoot>
                                                <th style="text-align: left; font-size: 18px; color: #000; font-weight: 700;">Discount (<?php echo $InvoiceDiscount; ?>%)</th>
                                                <th style="text-align: right; font-size: 18px; color: #000; font-weight: 700;"><?php echo number_format($TotalDiscount,2); ?></th>
                                            </tfoot>
                                            <?php }else{} ?>
                                        <?php }else{} ?>
                        ...
                        <div class="row" id="table-details">
                            <div class="page-description d-flex align-items-center">
                                <div class="page-description-content flex-grow-1 notranslate">
                                    <h1>Orders <font style="font-size: 15px;">Takeaway</font></h1>
                                </div>
                                    ...
                                    <div class="card widget widget-stats">
                                        <div class="card-body">
                                            ...
                                            <tbody id="product-area">
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo $ProductCountList; ?></td>
...
<!-------------------------Add Product to Plus---------------------------------------->
    ...
    <script>
        ...
        $.ajax({
                ...
                url:"takeaway_post/invoice_takeaway_save.php",
                type: 'POST',
                data: formData,
                //async: false,
                cache: false,
       ...
       // e.preventDefault(); //stop default form submission
        ...
        $("#cancel-table-btn").click(function(){
             ...
             $.ajax({
                ...
                url:"takeaway_post/cancel_invoice.php",
                type: 'POST',
                data: {
                ...
                success: function (data) {
                    ...
                    if(json.result){
                       ...
                       window.location.href = 'takeaway_invoice';
                       // document.getElementById('select-product').value = '0';
                       // document.getElementById('product-quantity').value = '0';
