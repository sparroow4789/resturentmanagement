...
<body>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Grocery Bill Form</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <form class="row g-3" id="Add-Grocery-Name">
                                                            <div class="col-md-12">
                                                                <label class="form-label">Grocery Shop Name *</label>
                                                                <input type="text" name="grocery_name" class="form-control" placeholder="Grocery Shop Name" required>
                                                            </div>

                                                            <div class="col-12">
                                                                <button type="submit" id="btn-add-grocery-name" class="btn btn-primary">Add Grocery Name</button>
                                                            </div>
                                                        </form>
    ...
    <script>
        ...
        $(document).on('submit', '#Add-Grocery-Name', function(e){
        e.preventDefault(); //stop default form submission

        $("#btn-add-grocery-name").attr("disabled",true);
        ...
        $.ajax({
                ...
                url:"post/add_grocery_details.php",
                type: 'POST',
                data: formData,
                //async: false,
                cache: false,
                ...
                success: function (data) {
                    ...
                    if(json.result){
                       ...
                       // location.reload();
                        ...
                        $("#btn-add-grocery-name").attr("disabled",false);
                    }
